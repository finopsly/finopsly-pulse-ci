...
export function buildSarif(findings: Finding[]): SarifBuildResult {
...
export function writeSarifFile(filePath: string, findings: Finding[]): SarifBuildResult {
  const result = buildSarif(findings)
